...
// VALUES ('aokledlight', 2);

// INSERT INTO user (`id`,`name`,email,phone,`password`,organizationId,role,state) VALUES ('428cc467-9709-4883-81e5-fd1b0426a1e7','wally','wally@aokledlight.com','','f802a8eae7c6063a6cd50248bb999fb3',4,1,2);
