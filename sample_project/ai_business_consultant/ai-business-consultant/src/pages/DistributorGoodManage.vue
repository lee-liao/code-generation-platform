  ...
  <div class="w-full h-full px-12">
    ...
    >
      ...
      >
        ...
        <!-- <el-form-item label="分享给分销商" prop="distributorStatus">
          <q-checkbox
...
export default defineComponent({
  ...
  setup(props, { root }) {
    ...
    const { mutate: updateCommodityByDistributorMutation } = useMutation(
      updateCommodityByDistributor
    );
    ...
    const handleDownload = async () => {
      try {
        ...
        console.error(root.$t("Distributor.Anerroroccurred"), error);
      }
    };
    // 时间戳
          ...
          if (valid) {
            ...
            try {
              if (createOrEditTitle.value == root.$t("goods.add")) {
                ...
                const updateRes = await updateCommodityByDistributorMutation({
                  commodity: commodity,
                  id: goodsId.value,
                  lawyerIds: goodMessage.value.lawyers,
                });
