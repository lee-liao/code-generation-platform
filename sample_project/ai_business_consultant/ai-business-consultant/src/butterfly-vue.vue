<template>
  <div :class="className">
    <div class="butterfly-vue-container"
         ref="canvas-dag"></div>
  </div>
</template>
...
import { defaultOptions } from './utils/default-data.js'
import { processNodes, processEdge, processGroups } from './utils/process.js'

import recalc from './utils/re-calc.js'
import relayout from './utils/re-layout.js'
